  ...
  <div class="h-screen w-screen flex">
    ...
    >
      <div class="w-[40%] shadow-xl p-10">
        ...
        <h5 class="text-gray-700 font-bold">Đăng nhập để tiếp tục</h5>
        ...
        <a href="" class="decoration-1 underline text-blue-600 text-xs">Bạn không đăng nhập được?</a
        >&nbsp;&nbsp;<RouterLink
          to="/signup"
          class="decoration-1 underline text-blue-600 text-xs"
          href=""
